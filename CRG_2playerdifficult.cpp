// 2 player difficult mode

#include "CatRescueGame.h"
#include <iostream>

void two_player_mode_diff::gameplay()
{
    system("Color B1");

    clearFosterHome2PlayerDifficult();
    ...
    while (isDone == false) {
        ...
        char arrayCats[7] = { 'T', 'C', 'G', 'B', 'W', 'F', 'R' };
        ...
        if (arrayCats[RandIndex] == 'F') {
            std::cout << "You rescued a Flame-point cat " << "(" << arrayCats[RandIndex] << ") !" << std::endl;
            std::cout << "Place them in foster care..." << std::endl;
        }
        if (arrayCats[RandIndex] == 'R') {
            std::cout << "You rescued a Russian blue cat " << "(" << arrayCats[RandIndex] << ") !" << std::endl;
            std::cout << "Place them in foster care..." << std::endl;
        }
